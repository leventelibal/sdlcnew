...
rm -rf .terraform/terraform.state # if you had answer state file approve yes  please remove terraform.state and apply source setenv.sh command so it will remove state file and recreate correct location 
